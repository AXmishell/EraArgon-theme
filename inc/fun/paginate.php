...
function argon_formatted_paginate_links($maxPageNumbers, $extraArgs = array(), $extraClasses = '', $target = 'list'){
	$args = array(
		'prev_text' => '',
		'next_text' => '',
		'before_page_number' => '',
...
function argon_formatted_paginate_links_for_all_platforms($extraArgs = array(), $target = 'list'){
	return argon_formatted_paginate_links(7, $extraArgs, "", $target) . argon_formatted_paginate_links(5, $extraArgs, " pagination-mobile", $target);
}
