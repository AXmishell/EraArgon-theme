...
/*说说*/
add_action('init', 'argon_init_shuoshuo');
function argon_init_shuoshuo(){
	$labels = array(
		'name' => __('说说', 'argon'),
...
//说说点赞
function argon_get_shuoshuo_upvotes($ID){
	$count_key = 'upvotes';
...
function argon_set_shuoshuo_upvotes($ID){
...
add_action('wp_ajax_upvote_shuoshuo' , 'argon_upvote_shuoshuo');
add_action('wp_ajax_nopriv_upvote_shuoshuo' , 'argon_upvote_shuoshuo');
