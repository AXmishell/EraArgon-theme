<?php
//输出评论分页页码
function argon_formatted_comment_paginate_links($maxPageNumbers, $extraClasses = ''){
	$args = array(
		'prev_text' => '',
		'next_text' => '',
		'before_page_number' => '',
...
function argon_formatted_comment_paginate_links_for_all_platforms(){
	return argon_formatted_comment_paginate_links(7) . argon_formatted_comment_paginate_links(5, " pagination-mobile");
}
function argon_comment_paginate_links_prev_url(){
	$args = array(
		'prev_text' => '',
		'next_text' => '',
		'before_page_number' => '',
