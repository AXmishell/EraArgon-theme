<?php
//评论验证码生成 & 验证
function argon_get_comment_captcha_seed($refresh = false){
...
function argon_get_comment_captcha(){
	$captcha = new captcha_calculation(argon_get_comment_captcha_seed());
	return $captcha -> getChallenge();
}
function argon_get_comment_captcha_answer(){
	$captcha = new captcha_calculation(argon_get_comment_captcha_seed());
	return $captcha -> getAnswer();
}
function argon_check_comment_captcha($comment){
...
add_filter('preprocess_comment' , 'argon_check_comment_captcha');

function argon_ajax_get_captcha(){
...
add_action('wp_ajax_nopriv_get_captcha', 'argon_ajax_get_captcha');

//初始化验证码种子
argon_get_comment_captcha_seed();
