...
function argon_after_entry_content(){
    $additionalContentAfterPost = argon_get_additional_content_after_post();
...
// 标签模块
add_action( 'argon_entry_tags', 'argon_entry_tags' );
function argon_entry_tags(){
    get_template_part( 'template-parts/entry/tags', get_post_type() );
}
